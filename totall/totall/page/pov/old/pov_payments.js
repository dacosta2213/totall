...
retail.pov_payments = erpnext.stock.StockController.extend({
	...
	set_payment_primary_action: function(){
		...
		this.dialog.set_primary_action(__("Cobrar"), function() {
			me.dialog.hide()
			me.submit_invoice()
		})
	},

	make_keyboard_pov: function(){
		var me = this;
		$(this.$body).empty();
		$(this.$body).html(frappe.render_template('pov_payment', this.frm.doc))
	...
	show_payment_details: function(){
		...
		if(this.frm.doc.payments.length){
			$.each(this.frm.doc.payments, function(index, data){
				$(frappe.render_template('pov_payment_details', {
